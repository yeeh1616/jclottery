			...
			if ( date == obj.id.substring(0,8) ) {
				html += '<div class="sai_c '+zhcss+'" '+visibleHtml+' id="'+obj.id+'" host="'+obj.hostname+'" guest="'+obj.guestname+'">' +
		          ...
		          '<div class="duiz fl tal">' +
		           ...
		           '</div>' ;
				if ( spfDg ) {
					html += '<div class="duiz_tz fl bcl danshi_d">' +
		             '<div class="dan_ico">' +
			          '<i class="triAngle"></i>' +
			          '<i class="text">单</i>' +
			          '</div>' ;
			    ...
			    html +=   		'<span class="duiz_tz_l fl bgc" bet="0" betName="客胜">' +
			                	'<div class="qiudui fl tal">客胜</div>' +
			                    '<div class="qiudui fl tal">'+sfodds[1]+'</div>' +
			                '</span>' +
			           		'<span class="duiz_tz_l fl bgc" bet="3" betName="主胜">' +
			                	'<div class="qiudui fl tal">主胜</div>' +
			                    '<div class="qiudui fl tal">'+sfodds[0]+'</div>' +
			                '</span>' +
			         '</div>' +
