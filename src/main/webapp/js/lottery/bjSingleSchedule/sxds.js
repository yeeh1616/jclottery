...
function callback() {
	...
	for ( var i = 0; i < schedules.length; i++ ) {
		...
		var spfOdds = obj.sxdsOdds.split(",");
		...
		if ( date == obj.uuid.substring(0,8) ) {
			...
			html +=		      '<div class="qr_wsj_tln_nx fl bgc" bet="0" betName="上单" '+spfnodocss+'>'+spfOdds[0]+'</div>'+
					                '<div class="qr_wsj_tln_n fl bgc" bet="1" betName="上双" '+spfnodocss+'>'+spfOdds[1]+'</div>'+
					                '<div class="qr_wsj_tln_n fl bgc" bet="2" betName="下单" '+spfnodocss+'>'+spfOdds[2]+'</div>'+
					                '<div class="qr_wsj_tln_n fl bgc" bet="3" betName="下双" '+spfnodocss+'>'+spfOdds[3]+'</div>'+
					          '</div>'+
