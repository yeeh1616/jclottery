...
$(document).ready(function () {
	...
	for ( var i = 0; i < schedules.length; i++ ) {
		...
		html += '<tr>'+
	        ...
	        '<td width="83">'+schedules[i].hostTeam+'(半) </td>'+
	        '<td width="83" class="w_bright">'+schedules[i].guestTeam+'(半)</td>'+
	        '<td width="32" class="d_blue" rowspan="2">'+odds[0]+'</td>'+
	        '<td width="32" class="d_green" rowspan="2">'+odds[1]+'</td>'+
	        '<td width="32" class="w_bright d_red" rowspan="2">'+odds[2]+'</td>';
	    ...
	    html +=  '</tr>';
	    html += '<tr>'+
	        '<td width="83">'+schedules[i].hostTeam+'(全) </td>'+
	        '<td width="83" class="w_bright">'+schedules[i].guestTeam+'(全)</td>';
		html += '<td width="28"><span class="zxgl_digt">3</span></td>';
		html += '<td width="28"><span class="zxgl_digt">1</span></td>';
		html += '<td width="28"><span class="zxgl_digt">0</span></td>';
	    html +=  '</tr>';
	...
	$(".condition_w,.shezhi_wbtn").live('click', function(){
		...
		for ( var i = 0; i < schedules.length; i++ ) {
			...
			html += '<tr sch="'+(i*2+1)+'">'+
		          '<td width="52" rowspan=2>'+(i+1)+'</td>'+
		          '<td width="64" class="zx_bd">'+schedules[i].hostTeam+'(半)</td>'+
		          '<td width="64">'+schedules[i].guestTeam+'(半)</td>'+
		          '<td width="40" class="zx_bd d_blue" rowspan=2>'+odds[0]+'</td>'+
		          '<td width="40" class="zx_bd d_green" rowspan=2>'+odds[1]+'</td>'+
		          '<td width="40" class="d_red" rowspan=2>'+odds[2]+'</td>'+
		        ...
		        '</tr>';
			html += '<tr sch="'+(i*2+2)+'">'+
		          '<td width="64" class="zx_bd">'+schedules[i].hostTeam+'(全)</td>'+
		          '<td width="64">'+schedules[i].guestTeam+'(全)</td>'+
		          '<td width="35" class="zx_bd"><span class="zxgl_digt left_s " bet="3">3</span></td>'+
		          '<td width="35" class="zx_bd"><span class="zxgl_digt left_s " bet="1">1</span></td>'+
		          '<td width="34" ><span class="zxgl_digt left_s " bet="0">0</span></td>'+
		          '<td width="47" class="zx_bd"><a href="javascript:void 0" class="d_red" name="coldRmvLnId">全</a></td>'+
