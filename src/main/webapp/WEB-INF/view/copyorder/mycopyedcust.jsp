...
<div class="gr-lbody">     
	...
	<div class="w_gcjl">
		...
		<ul>
			...
			<li><a href="/memberCenter/mycopyedCust.jhtml" class="active">我被定制的复制</a></li>
    ...
    <div class="w_gcjl_bg">
      <table width="100%" cellspacing="0" cellpadding="0" border="0" class="w_gcjl_gc">
		...
		<td width="60" class="biaoge1">定制人</td>
  ...
  <c:forEach var="list" items="${pagination.list}" varStatus="varStatus">
    ...
    <div class="pagetotal">
		<div class="ptotal">                                
			<form id="reportForm" name="reportForm" action="/memberCenter/mycopyedcust.jhtml" method="post">
