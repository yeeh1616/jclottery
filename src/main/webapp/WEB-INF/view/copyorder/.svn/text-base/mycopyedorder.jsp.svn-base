...
<div class="gr-lbody">     
	...
	<div class="w_gcjl">
		...
		<ul>
			...
			<li><a href="/memberCenter/mycopyedorder.jhtml" class="active">他人复制我的单</a></li>
		</ul>
		<span></span>
		<div class="clear"></div>
	</div>
    <div class="w_gcjl_bg">
      <table width="100%" cellspacing="0" cellpadding="0" border="0" class="w_gcjl_gc">
    	 <tr>
			...
			<td width="87" class="biaoge1">跟单单号</td>
			<td width="60" class="biaoge1">跟单人</td>
    ...
    <div class="pagetotal">
		<div class="ptotal">                                
			<form id="reportForm" name="reportForm" action="/memberCenter/mycopyedorder.jhtml" method="post">
