	...
	<div class="w_zjcx_t">	
		<ul>
        	...
        	<li><a id="myAppointed" href="/memberCenterCustom/custom.jhtml?type=3">我指定的跟单人</a></li>
       		<li><a id="myAppointToMe" href="/memberCenterCustom/custom.jhtml?type=4" class="current">我被指定的记录</a></li>
            <div class="clear"></div>
    	</ul>
    </div>
   
    <div class="w_zjcx_c w_show">
    <form id="reportForm" name="reportForm" action="/memberCenterCustom/custom.jhtml?type=4" method="post">
