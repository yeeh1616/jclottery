  ...
  <%@include file="menu.jsp" %>
   ...
   <div class="safebox">
      <div class="sftab">
        ...
        <h1 class="zz" style="cursor:pointer" onclick="location.href='/memberCenter/putMoneySFTZ.jhtml'">快捷支付</h1>
        </c:if>	
      ...
      <div class="notice2"><b>提示：</b>有盛付通提供支付通道。单笔5000元，月累计20000元，个别银行如不能支付，请选择‘网银支付’-->'平台支付‘到盛付通首映台支付</div>
  <!--新增加一个DIV 网银充值-->    
      <div class="cx_plant">
    ...
    <div class="product showx">
      <div class="paymethod">
         ...
         <li>
          ...
          <li>
            <input type="radio" checked values="工商银行" value="ICBC" name="payBank" channel="2" payType="DR" style="display:none">
    ...
    <div class="product">
      <div class="paymethod">
         <ul>
            ...
            <img src="/images/bank/BOC.png"  onclick="doCheck(this)" /> </li>
          <li>
            <input type="radio" checked values="工商银行" value="ICBC" name="payBank" channel="2" payType="CR" style="display:none">
            <img src="/images/bank/ICBC.png"  onclick="doCheck(this)" /> </li>
          <li>
          ...
          <li>
            <input type="radio" values="渤海银行" value="CBHB" name="payBank" channel="2" payType="CR" style="display:none">
            <img src="/images/bank/CBHB.png"  onclick="doCheck(this)" /> </li>
          <li>
            <input type="radio" values="成都银行" value="BOCD" name="payBank" channel="2" payType="CR" style="display:none">
            <img src="/images/bank/BOCD.png"  onclick="doCheck(this)" /> </li>
          <li>
            <input type="radio" values="上海市农村商业银行" value="SHRCB" name="payBank" channel="2" payType="CR" style="display:none">
            <img src="/images/bank/SHRCB.png"  onclick="doCheck(this)" /> </li>
          <li>
            <input type="radio" values="汉口银行" value="HKBCHINA" name="payBank" channel="2" payType="CR" style="display:none">
