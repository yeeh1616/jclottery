...
.f_cont_gendan{width:643px;background:#fff7eb;padding:10px;color:#cd9964;}
...
.f_cont_jin{width:664px;height:51px;background:#f6f6f6;line-height:51px;}
...
<div class="f_cont">
    <div class="f_cont_l fl"><a href="#"></a></div>
    <div class="f_cont_r fl">
      <!-- <div class="f_cont_r_top">
        <ul>
          <li class="shen">累计中奖金额</li>
          <li class="shen">定制记录</li>
          <li class="shen">定制人数</li>
          <li class="qian red">0元</li>
          <li class="qian blue">0元</li>
          <li class="qian">0</li>
          <div class="clear"></div>
        </ul>
      </div> -->
