...
<div class="memberbox">
  ...
  <div class="tzgl">
    	<div class="safebox">
        	<div class="tzxq" style="margin-top:0px">实名验证</div>
            <div class="notice2"><b>温馨提示：</b>您已经通过了实名验证，实名验证不允许修改。</div>
            <div class="tk1">
            	<ul>
                	<li class="link"><img src="/images/war.gif"/>证件名称<span>${mb.certiName}</span></li>
                	<li><img src="/images/ok.gif"/>证件号码<span>${mb.certiNumber}</span></li>
                	<li><img src="/images/ok.gif"/>手机号码<span>${mb.phone}</span></li>
                </ul>
            </div>
