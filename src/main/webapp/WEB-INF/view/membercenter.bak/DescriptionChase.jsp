...
<div class="memberbox">
    ...
    <div class="mbright">
   	  <div class="mrcont">
   	    <div class="mrtop">
           <div class="jcbf"> 
           <span class=" back"><a href="/memberCenter/chaseList.jhtml">返回列表</a></span>
     ...
     <table width="100%" border="0" cellspacing="1" cellpadding="0" bgcolor="#becfd7">
			  ...
			  <c:forEach var="list" items="${mathorder.lotterypin.list}" varStatus="varstatus">
				...
				<form id="reportForm" name="reportForm" action="/memberCenter/DescriptionChase.jhtml" method="post">
