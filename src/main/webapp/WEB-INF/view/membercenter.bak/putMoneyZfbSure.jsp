...
<div class="memberbox">
  ...
  <%@include file="menu.jsp" %>
    <div class="tzgl">
        ...
        <div class="notice2"><b>提示：</b>本次充值有<strong>支付宝</strong>提供接口支持。各银行对单笔金额与每日总额都有限制，请参考各银行的使用说明。</div>
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
       	    <tr>
        	      ...
        	      <td width="90%"><img src="/images/bank/${param.payBank}.png" width="148" height="48" /> 
        	      	<img src="/images/pmethdos.jpg" width="148" height="48" style="cursor:pointer" onclick="location.href='/memberCenter/putMoneyZfb.jhtml'"/></td>
   	        </tr>
        	    <tr>
