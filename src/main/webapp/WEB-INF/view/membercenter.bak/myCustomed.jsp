...
<div class="memberbox">
  ...
  <div class="w_zjcx">
	...
	<div class="w_zjcx_t">	
		<ul>
    		<li><a id="myCustoming" href="/memberCenterCustom/custom.jhtml?type=1">我定制的跟单</a></li>
       		<li><a id="myCustomed" href="/memberCenterCustom/custom.jhtml?type=2" class="current">我被定制的记录</a></li>
    ...
    <form id="reportForm" name="reportForm" action="/memberCenterCustom/custom.jhtml?type=2" method="post">
