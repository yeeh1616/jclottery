...
<!--footer-->
<div class="footer_bg">
  <div class="footer_bangzhu"><c:if test="${!beHLwUnion}"><img src="/cytxhome/images/f_logo.png" width="85" height="104" /></c:if>
     <div class="footer_list">
      <h1>新手上路</h1>
      <ul>
        <li> <a href="http://${store.netUrl}/common/register/index.jhtml" target="top"><i class="cube"></i>注册充值</a> </li>
        <li> <a href="http://${store.netUrl}/help/help_center/four-buy/buy.html" target="top"><i class="cube"></i>购彩流程</a> </li>
        <li> <a href="http://${store.netUrl}/help/help_center/five-tixian/two-lingqu.html" target="top"><i class="cube"></i>领奖流程</a> </li>
      </ul>
    </div>
    <div class="footer_list">
      <h1>帮助中心</h1>
      <ul>
        <li> <a href="http://${store.netUrl}/help/help_center/nine-ofen/ofen.html" target="top"><i class="cube"></i>常见问题 </a> </li>
        <li> <a href="http://${store.netUrl}/help/help_center/eight-shuyu/shuyu.html" target="top"><i class="cube"></i>彩票术语</a> </li>
        <li> <a href="http://${store.netUrl}/help/help_center/seven-wanfa/wanfa.html" target="top"><i class="cube"></i>彩种介绍</a> </li>
      </ul>
    </div>
    <div class="footer_list">
      <h1>支付方式 </h1>
    ...
    <div class="footer_list">
      <h1>中奖福地 </h1>
      <ul>
        <li> <a href="javascript:void 0"><i class="cube"></i>大奖回顾 </a> </li>
        <li> <a href="javascript:void 0"><i class="cube"></i>中奖英雄榜</a> </li>
        <li> <a href="javascript:void 0"><i class="cube"></i>超级合买人</a></li>
      </ul>
    </div>
  </div>
  ...
  <a href="javascript:void 0"><img  src="/cytxhome/images/1.jpg" target="_blank" /></a>
   ...
   <a href="http://webscan.360.cn/index/checkwebsite/url/${store.netUrl}" target="_blank"><img  src="/cytxhome/images/5.jpg" /></a>
   <a href="http://v.pinpaibao.com.cn/authenticate/cert/?site=cp020.com&at=realname" target="_blank"><img src="/cytxhome/images/sm_124x47.png"></a>
    <div class="clear"></div>
    <c:if test="${!beHLwUnion}"><div class="wenzicai">北京彩游天下网络科技有限责任公司 <c:if test="${sessionScope.domain.storeMobile != null}">客服电话：${sessionScope.domain.storeMobile}</c:if> &nbsp;&nbsp;&nbsp;备案：京ICP备14053026号-3  &nbsp;&nbsp;&nbsp;ICP经营许可证：京ICP证160084号</div>
      ...
      <div class="clear"></div>
        ...
        <div class="loginbtn">
          ...
          <div class="logcheckbox fl">
            ...
            记住密码</div>
          <div class="fotget"><a href="http://${store.netUrl}/findpassword/index.jhtml">忘记密码?</a></div>
          <div class="sigin">还没有账号?<a id="sigup_now" href="http://${store.netUrl}/common/register/index.jhtml">立即注册</a></div>
          <div class="clear"></div>
        </div>
    </div>
  </div>
...
<div class="side">
  <ul>
    <li><a href="http://${store.netUrl}/playerintro/index.jhtml">
    ...
    <li><a href="javascript:void(0);" onclick="window.open('http://wpa.qq.com/msgrd?v=5&uin=${store.storeQq}&site=在线咨询&menu=yes');">
