...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<c:set var="pageName" value="彩票开奖-体彩6+1" scope="page"></c:set>
		<%@include file="../include/titlePage.jsp"%>
		<link href="/css/layout_hao.css" rel="stylesheet" type="text/css" />
		<script type="text/javascript" src="http://101.200.213.247:9380/global/open/20/open.js"></script>
		<script>
	var license_type_id = '20';
</script>
	</head>
	<body>
		...
		<div class="common_w">
			...
			<div class="sfc_top">
				<div class="sfc_c_c">
					<span class="sfc_b">浙江6+1</span><span class="kjq">第<select
			...
			<div class="jiangjin_">
				...
				<div class="jiangjin_l">
					<div class="sfc_c_l fl">
						<div class="jiangjin_i tc61-logo"></div>
					</div>
					<div class="fl">
						<div class="z_money">
							<p>
