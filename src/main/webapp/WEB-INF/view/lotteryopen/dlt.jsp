...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript" src="http://101.200.213.247:9380/global/open/4/open.js"></script>
		<script>
		var license_type_id = '4';
	</script>
		<%--<script>
		$(document).ready(function (){
			var option = '';
			for ( var i = 0; i < games.length; i++ ) {
				option += '<option value="'+games[i].dateNum+'">'+games[i].dateNum+'</option>';
			}
	...
	<body>
		...
		<div class="common_w">
			...
			<div class="sfc_top">
				<div class="sfc_c_c">
					<span class="sfc_b">大乐透</span><span class="kjq">第<select
			...
			<div class="jiangjin_">
				...
				<div class="jiangjin_l">
					<div class="sfc_c_l fl">
						<div class="jiangjin_i big-logo"></div>
					</div>
					<div class="fl">
						<div class="z_money">
							<p>
