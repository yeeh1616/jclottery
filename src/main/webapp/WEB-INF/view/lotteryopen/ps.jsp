...
<script type="text/javascript" src="http://101.200.213.247:9380/global/open/1/open.js"></script>
<script>
	var license_type_id = '1';
</script>
</head>
<body>
...
<script type="text/javascript" src="/js/lotteryopen/math.js"></script>
		<div class="common_w">
			...
			<div class="sfc_top">
				<div class="sfc_c_c">
					<span class="sfc_b">排列三</span><span class="kjq">第<select
			...
			<div class="jiangjin_">
				...
				<div class="jiangjin_l">
					<div class="sfc_c_l fl">
						<div class="jiangjin_i pai3-logo"></div>
					</div>
					<div class="fl">
						<div class="z_money">
							<p>
