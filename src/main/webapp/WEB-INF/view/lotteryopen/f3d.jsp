...
<c:set var="pageName" value="彩票开奖-排列三开奖" scope="page"></c:set>
<%@include file="../include/titlePage.jsp" %>
<link href="/css/layout_hao.css" rel="stylesheet" type="text/css" />
<script type="text/javascript" src="http://101.200.213.247:9380/global/open/12/open.js"></script>
<script>
	var license_type_id = '12';
</script>
</head>
<body>
...
<script type="text/javascript" src="/js/lotteryopen/math.js"></script>
		<div class="common_w">
			...
			<div class="sfc_top">
				<div class="sfc_c_c">
					<span class="sfc_b">福彩3D</span><span class="kjq">第<select
							id="select1"></select>期开奖</span><span id="date0_"></span>
					<a href="/lottery/index.jhtml?licenseId=1&p=zxpt"><input type="button" class="liji" value="立即购买" /></a>
				</div>
			</div>
			<div class="jiangjin_">
				...
				<div class="jiangjin_l">
					<div class="sfc_c_l fl">
						<div class="jiangjin_i sd-logo"></div>
					</div>
					<div class="fl">
						<div class="z_money">
							<p>
