...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<c:set var="pageName" value="彩票开奖-足彩进球彩开奖" scope="page"></c:set>
		<%@include file="../include/titlePage.jsp"%>
		<link rel="stylesheet" type="text/css"
			href="/css/kaijiangxiangqing.css" />
			<script type="text/javascript" src="http://101.200.213.247:9380/global/open/8/open.js"></script>
		<script>
	var license_type_id = '8';
</script>
	</head>
	<body>
		...
		<div class="common_w">
			...
			<div class="sfc_top">
				<div class="sfc_c_c">
					<span class="sfc_b">4场进球</span><span class="kjq">第<select
							id="select1"></select>期开奖</span><span id="date0_"></span>
					<a href="/lottery/index.jhtml?licenseId=8"><input type="button"
			...
			<div class="jiangjin_">
				<div class="jiangjin_l">
					<div class="sfc_c_l fl">
						<div class="jiangjin_i fball-logo"></div>
					</div>
					<div class="fl">
						<div class="z_money">
							<p>
