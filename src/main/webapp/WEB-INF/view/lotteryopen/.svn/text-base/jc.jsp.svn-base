...
<c:set var="pageName" value="彩票开奖-竞彩足球开奖" scope="page"></c:set>
...
<div class="jc-warp">	
	...
	<script type="text/javascript" src="http://101.200.213.247:9380/global/open/9/${currDate}.js"></script>
	<script type="text/javascript" src="/js/lotteryopen/jc.js"></script>
    <!--head end-->
	
    <!--fb-warp start-->
	<div class="fb-warp">
    	<div class="fb-title">
        	<form id="form1" name="form1" method="post" action="/lotteryopen/jc.jhtml">
        ...
        <table width="0" border="0" cellspacing="0" cellpadding="0" class="fb-tab01" id="contentDetail_">
          <tr>
            ...
            <th><div class="c3">主队</div></th>
            <th><div class="c4">让球</div></th>
            <th><div class="c5">客队</div></th>
            <th><div class="c6">比分</div></th>
            <th>
            	<div class="c7">
                	<p>让球胜平负</p>
                </div>
          ...
          <tr><td colspan="20">
          	 开奖数据仅供参考，一切以官方发布数据为准。<a href="http://info.sporttery.cn/football/match_result.php" target="blank"><u>查看官方开奖数据</u></a>
          	 	</td>
          </tr>
        </table>
    </div>
