...
<c:set var="pageName" value="彩票开奖-北京单场" scope="page"></c:set>
...
<div class="jc-warp">	
	...
	<script type="text/javascript" src="http://101.200.213.247:9380/global/open/21/${currDate}.js"></script>
	<script type="text/javascript" src="/js/lotteryopen/bjdc.js"></script>
    <!--head end-->
	
    <!--fb-warp start-->
	<div class="fb-warp">
    	<div class="fb-title">
        	<form id="form1" name="form1" method="post" action="/lotteryopen/bjdc.jhtml">
        	...
        	<h3><em></em><span>北京单场开奖</span></h3>
        </div>
        <table width="0" border="0" cellspacing="0" cellpadding="0" class="fb-tab01" id="contentDetail_">
          <tr>
            <th><div class="c0_b">编号</div></th>
            <th><div class="c1_b">赛事</div></th>
            <th><div class="c2_b">比赛时间</div></th>
            <th><div class="c3_b">主队</div></th>
            <th><div class="c4_b">让球</div></th>
            <th><div class="c5_b">客队</div></th>
            <th><div class="c6_b">全场比分</div></th>
            <th><div class="c7_b"><p>半场比分</p></div></th>
          </tr>
