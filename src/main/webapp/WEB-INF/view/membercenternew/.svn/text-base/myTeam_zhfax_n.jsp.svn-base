  ...
  <div class="user_plant">
    ...
    <div class="user_r">
      <div class="gr-lbody"> 
        <!--方案详情begin-->
        <div class="help_tzxq">
          <div class="help_tzxq_t">${mathorder.chasingOrder.licenseName}   <font class="bh">${mathorder.chasingOrder.id}</font>号追号方案详情单<a href="/lottery/index.jhtml?licenseId=${mathorder.chasingOrder.licenseId }" class="fanhui">继续购买</a><a href="/memberCenterNew/myTeamChaseMember.jhtml" class="goon">返回列表</a></div>
          ...
          <div class="chasenumber ">
           ...
           <div class="pagetotal">
				<div class="ptotal">
					<customertags:paging formId="reportForm" pageNo="${mathorder.lotterypin.pageNo}" count="${mathorder.lotterypin.totalCount}" pageSize="${mathorder.lotterypin.pageSize}" />
			    </div>
		   </div>
        </div>
        
        <form id="reportForm" name="reportForm" action="/memberCenterNew/myTeamZhfax.jhtml" method="post">
