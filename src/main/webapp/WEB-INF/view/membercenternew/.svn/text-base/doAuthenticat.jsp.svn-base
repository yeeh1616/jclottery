...
<!--安全等级begin-->
<div class="gr-safedj">
	<div class="gr-safe-l"> 实名认证成功 </div>
...
<div class="gr-lbody">     
    <!--具体信息begin-->
     ...
     <div class="safe_tex fl">您好，实名认证成功，不允许更改。</div>
     </div>
    <div class="gr-jtma safe-tw">
      <div class="gr-jtmal">
        <div class="gr-jname">真实姓名：</div>
        <div class="r_zs">${mb.certiName}</div>
        <div class="clear"></div>
        </div>
      <div class="gr-jtmal">
        <div class="gr-jname">证件类型：</div>
        <div class="r_zs">身份证</div>
        <div class="clear"></div>
      </div>
      <div class="gr-jtmal">
        <div class="gr-jname">证件号码：</div>
        <div class="r_zs">${mb.certiNumber}</div>
        <div class="clear"></div>
      </div>
      <div class="clear"></div>
    </div>
