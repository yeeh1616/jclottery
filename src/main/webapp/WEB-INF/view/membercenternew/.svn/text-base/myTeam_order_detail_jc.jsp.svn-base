...
<%@include file="menu.jsp" %>
    <div class="user_r">
      <div class="gr-lbody"> 
        <!--方案详情begin-->
        <div class="help_tzxq">
          <div class="help_tzxq_t"><span>${guessorder.lotteryorder.licenseName}</span> <span>${guessorder.lotteryorder.id}号方案详情</span><a href="/lottery/index.jhtml?licenseId=${guessorder.lotteryorder.licenseId }" class="fanhui">继续购买</a><a href="/memberCenterNew/myTeamPurchas.jhtml" class="goon">返回列表</a></div>
            ...
            <div class="help_tzxq_gcxqym">
              <table width="100%" cellspacing="0" cellpadding="0" border="0" class="w_gcjl_tz">
                <tr>
                  <th width="90">场次</th>
                  <c:choose>
                  	<c:when test="${param.LicenseId == 10}">
                  		<th width="90">客队</th>
                  		<th width="90">主队</th>
                  	</c:when>
                  	<c:otherwise>
                ...
                <table width="100%" cellspacing="0" cellpadding="0" border="0" class=" w_gcjl_tz_n">
                 <c:forEach var="list" items="${guessorder.schudles}" varStatus="varstatus">
              	...
              	<c:choose>
                    ...
                    <td width="205"><span class="tzxkuai">${list.bets}</span></td>
                    <td>
                    <c:choose>
