   ...
   <%@include file="menu.jsp" %>
    <div class="user_r">
      <div class="gr-lbody"> 
        <!--方案详情begin-->
        <div class="help_tzxq">
          <div class="help_tzxq_t"><span>${zcorder.lotteryorder.licenseName}</span> <span>${zcorder.lotteryorder.id}号方案详情</span><a href="/lottery/index.jhtml?licenseId=${zcorder.lotteryorder.licenseId }" class="fanhui">继续购买</a><a href="/memberCenterNew/purchasList.jhtml" class="goon">返回列表</a></div>
