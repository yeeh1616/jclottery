...
<script type="text/javascript" src="/js/lottery/luckyracing/ysq3.js"></script>
	...
	<div class="qycodl">
    	<div class="qycodla">
        	<div class="qycodlaTit">
            	<span>玩法提示：预测12辆赛车中按顺序获得前三名的赛车颜色，单注最高奖金限额为<em class="red">3852</em>元</span>
            ...
            <div class="qycondlCon">
            	<div class="qyconYs">
                    <span class="qyconYsb">冠军颜色</span>
                    <span class="qyconYsa">当前遗漏</span>
                    <span class="qyconYsb">亚军颜色</span>
                    <span class="qyconYsa">当前遗漏</span>
                    <span class="qyconYsb">季军颜色</span>
                    <span class="qyconYsa">当前遗漏</span>
                </div>
                ...
                <ul class="qecondlConr" id="line3AreaId">
                	<li>
                        <p class="qecondlConrp1 qep2a"><span class="qecondlConrp2a" bet="A" bet2="红色"><span>红色</span><span>01 02</span></span></p>
                    	<p class="qecondlConrp3">19</p>
                    </li>
