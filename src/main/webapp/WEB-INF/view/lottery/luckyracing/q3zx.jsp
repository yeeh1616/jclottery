...
<c:set var="pageName" value="前三直选-幸运赛车" scope="page"></c:set>
...
<script type="text/javascript" src="/js/lottery/luckyracing/q3zx.js"></script>
<jsp:include page="./q3header.jsp"></jsp:include>

<div class="qycod">
	<div class="qycodl">
    	<div class="qycodla">
        	<div class="qycodlaTit">
            	<span>玩法提示：猜中当前期比赛冠亚季军即为中奖,根据奖金对照表派奖,单注浮动奖金最高可获<em class="red">50000</em>元</span>
            ...
            <div class=qycondlCon>
                ...
                <div class="qyconQsall">
                    <div class="qyconQs">
                        <span class="qyconQsb">季军选择</span>
                        <span class="qyconQsa">季军遗漏</span>
                    </div>
                    <ul class="qyconQsy" id="jjPanelId">
                        <li>
                            <p class="qyconQsya qyp2a"><span class="qyconQsy2a">01</span></p>
                            <p id="j01omit" class="qyconQsy3">-</p>
                        </li>
                        <li>
                            <p class="qyconQsya qyp2b"><span class="qyconQsy2a">02</span></p>
                            <p id="j02omit" class="qyconQsy3">-</p>
                        </li>
                        <li>
                            <p class="qyconQsya qyp2c"><span class="qyconQsy2a">03</span></p>
                            <p id="j03omit" class="qyconQsy3">-</p>
                        </li>
                        <li>
                            <p class="qyconQsya qyp2d"><span class="qyconQsy2a">04</span></p>
                            <p id="j04omit" class="qyconQsy3">-</p>
                        </li>
                        <li>
                            <p class="qyconQsya qyp2e"><span class="qyconQsy2a">05</span></p>
                            <p id="j05omit" class="qyconQsy3">-</p>
                        </li>
                        <li>
                            <p class="qyconQsya qyp2f"><span class="qyconQsy2a">06</span></p>
                            <p id="j06omit" class="qyconQsy3">-</p>
                        </li>
                        <li>
                            <p class="qyconQsya qyp2g"><span class="qyconQsy2a">07</span></p>
                            <p id="j07omit" class="qyconQsy3">-</p>
                        </li>
                        <li>
                            <p class="qyconQsya qyp2h"><span class="qyconQsy2a">08</span></p>
                            <p id="j08omit" class="qyconQsy3">-</p>
                        </li>
                        <li>
                            <p class="qyconQsya qyp2i"><span class="qyconQsy2a">09</span></p>
                            <p id="j09omit" class="qyconQsy3">-</p>
                        </li>
                        <li>
                            <p class="qyconQsya qyp2j"><span class="qyconQsy2a">10</span></p>
                            <p id="j10omit" class="qyconQsy3">-</p>
                        </li>
                        <li>
                            <p class="qyconQsya qyp2k"><span class="qyconQsy2a">11</span></p>
                            <p id="j11omit" class="qyconQsy3">-</p>
                        </li>
                        <li>
                            <p class="qyconQsya qyp2l"><span class="qyconQsy2a">12</span></p>
                            <p id="j12omit" class="qyconQsy3">-</p>
                        </li>
                    </ul>
                </div>
            </div>
