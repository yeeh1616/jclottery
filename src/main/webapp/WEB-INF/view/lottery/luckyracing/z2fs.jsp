...
<c:set var="pageName" value="组二复式-幸运赛车" scope="page"></c:set>
...
<script type="text/javascript" src="/js/lottery/luckyracing/z2fs.js"></script>
    	...
    	<div class="qycodla">
            ...
            <div class="qycondlCon">
            	<div class="qyconQsall">
                    <div class="qyconQs">
                        <span class="qyconFsb">冠亚军<p>选择</p></span>
                    </div>
                    <ul class="qyconQsy">
                        <li>
