...
<c:set var="pageName" value="组三复式-幸运赛车" scope="page"></c:set>
...
<script type="text/javascript" src="/js/lottery/luckyracing/z3fs.js"></script>
	...
	<div class="qycodl">
    	<div class="qycodla">
        	<div class="qycodlaTit">
            	<span>玩法提示：猜中当前期比赛冠亚季军即为中奖,根据奖金对照表派奖,单注浮动奖金最高可获<em class="red">27774</em>元</span>
            ...
            <div class="qycondlCon">
            	<div class="qyconQsall">
                    <div class="qyconQs">
                        <span class="qyconFsb">冠亚季军<p>选择</p></span>
                    </div>
                    <ul class="qyconQsy">
                        <li>
