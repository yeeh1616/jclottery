...
<c:set var="pageName" value="组二胆拖复式-幸运赛车" scope="page"></c:set>
...
<script type="text/javascript" src="/js/lottery/luckyracing/z2dt.js"></script>
<jsp:include page="./z2header.jsp"></jsp:include>
