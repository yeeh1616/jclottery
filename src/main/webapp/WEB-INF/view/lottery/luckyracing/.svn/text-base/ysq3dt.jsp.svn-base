...
<script type="text/javascript" src="/js/lottery/luckyracing/ysq3dt.js"></script>
	...
	<div class="qycodl">
    	<div class="qycodla">
            ...
            <div class="qycondlCon">
            	<div class="qyYs">
                    <span class="qyYsb">胆码</span>
                    <span class="qyYsb">拖码</span>
                </div>
                <ul class="qecondlYonr" id="line1AreaId">
                	<li>
                ...
                <ul class="qecondlYonr" id="line2AreaId">
                	<li>
                        <p class="qecondlConrp1 qep2a"><span class="qecondlConrp2a" bet="A" bet2="红色"><span>红色</span><span>01 02</span></span></p>
                    	<p class="qecondlConrp3">19</p>
                    </li>
