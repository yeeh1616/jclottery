...
<c:set var="pageName" value="前二复式投注-幸运赛车" scope="page"></c:set>
...
<script type="text/javascript" src="/js/lottery/luckyracing/q2fs.js"></script>
    	...
    	<div class="qycodla">
            ...
            <div class=qycondlCon>
                ...
                <div class="qyconQsall">
                    <div class="qyconQs">
                        <span class="qyconFsb">冠军季军<p>选择</p></span>
                    </div>
                    <ul class="qyconQsy">
                        <li>
