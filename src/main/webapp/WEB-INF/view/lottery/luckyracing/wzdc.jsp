...
<c:set var="pageName" value="位置单车-幸运赛车" scope="page"></c:set>
...
<script type="text/javascript" src="/js/lottery/luckyracing/wzdc.js"></script>
	...
	<div class="qycodl">
    	<div class="qycodla">
        	<div class="qycodlaTit">
            	<span>玩法提示：猜中当期某辆车进入前三名即为中奖,根据奖金对照表派奖,单注浮动奖金最高可获<em class="red">36</em>元</span>
