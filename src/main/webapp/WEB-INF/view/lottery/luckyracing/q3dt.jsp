...
<c:set var="pageName" value="前三胆拖复式-幸运赛车" scope="page"></c:set>
...
<script type="text/javascript" src="/js/lottery/luckyracing/q3dt.js"></script>
    	...
    	<div class="qycodla">
            ...
            <div class=qycondlCon>
                ...
                <div class="qyconQsall">
                    <div class="qyconQs">
                        <span class="qyconDsb">胆码</span>
                        <span class="qyconDsb">拖码</span>
                    </div>
