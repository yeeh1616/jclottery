...
<c:set var="pageName" value="排列五" scope="page"></c:set>
...
<script type="text/javascript" src="/js/lottery/11x5/dssc.js"></script>
...
<div class="common_w" id="betPanalId">  
    ...
    <div class="sais_c">
         <div class="w_ggfs">
				<div class="w_ggfs_c">
				<div class="w_ggfs_t">请先选择玩法:
				<input type="radio" name="playTypeName" value="1"/>前一
				<input type="radio" name="playTypeName" value="2"/>任二
				<input type="radio" name="playTypeName" value="3"/>任三
				<input type="radio" name="playTypeName" value="4"/>任四
				<input type="radio" name="playTypeName" value="5" checked/>任五
				<input type="radio" name="playTypeName" value="6"/>任六
				<input type="radio" name="playTypeName" value="7"/>任七
				<input type="radio" name="playTypeName" value="8"/>任八
				<input type="radio" name="playTypeName" value="9"/>前二直
				<input type="radio" name="playTypeName" value="10"/>前二组
				<input type="radio" name="playTypeName" value="11"/>前三直
				<input type="radio" name="playTypeName" value="12"/>前三组
				</div> 
				
				<span class="w_peim">1</span>选择文件</div> 
				...
				<div class="ckgs"><a name="pailewu" href="javascript:void(0)">查看上传格式</a></div>
				</div>
				           <div class="w_ggfs_c"><span class="w_peim">2</span>确认提交</div> 
				            ...
				            <div class="jzsj">该方案截止时间：<span>${fn:substring(game.stopTime,0,16)}</span></div>
				                ...
				                <div class="qrfk w_anniu"><a href="javascript:void 0" class="quer" id="lottFormBtnId">确认提交</a></div>
				            </div> 
         </div> 
        </div>
