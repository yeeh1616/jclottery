...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<c:set var="pageName" value="北京单场胜平负单式上传" scope="page"></c:set>
...
<div id="betPanalId">
      ...
      <jsp:include page="./header.jsp"></jsp:include>
    	...
    	<div class="sais_c">
         <div class="w_ggfs">
         	<div class="w_ggfs_t">
         	<input type="radio" name="typesel" onclick="location.href='/lottery/index.jhtml?licenseId=21&p=spf'" <c:if test="${p == 'spf' }">checked</c:if>/>
			过关投注
         	<input type="radio" name="typesel" onclick="location.href='/lottery/index.jhtml?licenseId=21&p=dssc'" <c:if test="${p == 'dssc' }">checked</c:if>/>
			单式上传
         	
         	</div> 
            <div class="w_ggfs_c n_btop"><span class="w_peim ">1</span>选择场次<span class="w_changci" id="maxSelectId">最多可选择15场</span></div>
            <div id="dsSchDivId"></div>
            <div class="w_ggfs_t" style="display:none">请先选择玩法:
            <input type="radio" name="playTypeName" value="2" checked/>平胜负
            <input type="radio" name="playTypeName" value="3"/>比分
            <input type="radio" name="playTypeName" value="4"/>半全场
            <input type="radio" name="playTypeName" value="5"/>总进球
            <input type="radio" name="playTypeName" value="6"/>上下单双
            </div> 
            <div class="w_ggfs_c"><span class="w_peim">2</span>选择过关方式</div> 
            <div class="w_ggfsc_fxc" id="dsPassTId">
           		 <ul>
           		 	<li><input type="radio" name="dsPtName" value="1"/><a href="javascript:void 0">单关</a></li>
                    ...
                    <li><input type="radio" name="dsPtName" value="9"/><a href="javascript:void 0">9串1</a></li>
                    <li><input type="radio" name="dsPtName" value="10"/><a href="javascript:void 0">10串1</a></li>
                    <li><input type="radio" name="dsPtName" value="11"/><a href="javascript:void 0">11串1</a></li>
                    <li><input type="radio" name="dsPtName" value="12"/><a href="javascript:void 0">12串1</a></li>
                    <li><input type="radio" name="dsPtName" value="13"/><a href="javascript:void 0">13串1</a></li>
                    <li><input type="radio" name="dsPtName" value="14"/><a href="javascript:void 0">14串1</a></li>
                    <li><input type="radio" name="dsPtName" value="15"/><a href="javascript:void 0">15串1</a></li>
                	<div class="clear"></div>
            	</ul>
            </div>
