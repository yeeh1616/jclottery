...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<c:set var="pageName" value="北京单场半全场单式上传" scope="page"></c:set>
...
<div id="betPanalId">
      ...
      <jsp:include page="./header.jsp"></jsp:include>
    	...
    	<div class="sais_c">
         <div class="w_ggfs">
         	<div class="w_ggfs_t">
         	<input type="radio" name="typesel" onclick="location.href='/lottery/index.jhtml?licenseId=21&p=bqc'" <c:if test="${p == 'bqc' }">checked</c:if>/>
			过关投注
         	<input type="radio" name="typesel" onclick="location.href='/lottery/index.jhtml?licenseId=21&p=bqcdssc'" <c:if test="${p == 'bqcdssc' }">checked</c:if>/>
			单式上传
