...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<c:set var="pageName" value="上下单双" scope="page"></c:set>
...
<div class="big_bg" id="betPanalId">
      <div class="common_w sfhr">
      <jsp:include page="./header.jsp"></jsp:include>
    
    <div id="navlist_tz" class="sais_t">
        <div class="w_shengfuchoose">
			<span>
			<input type="radio" name="typesel" onclick="location.href='/lottery/index.jhtml?licenseId=21&p=sxds'" <c:if test="${p == 'sxds' }">checked</c:if>/>
			过关投注</span>
			<span>
			<input type="radio" name="typesel" onclick="location.href='/lottery/index.jhtml?licenseId=21&p=sxdsdssc'" <c:if test="${p == 'sxdsdssc' }">checked</c:if>/>
			单式上传</span>
	   </div>   
       <table width="100%" border="0" cellpadding="0" cellspacing="0" class="sais_ts">
        <tr>
        <td width="12%" style="border-bottom:0px"><a href="#" class="xd">赛事<span class="xxj sais"></span></a></td>
        <td width="8%" style="border-bottom:0px"><a href="#" class="xd">停售<span class="xxj sais"></span></a></td>
        <td width="18%">主队VS客队</td>
        <td width="36%"><span class="qr_wsj_tcn_w">上+单</span><span class="qr_wsj_tcn_w">上+双</span>
        <span class="qr_wsj_tcn_w">下+单</span><span class="qr_wsj_tcn_w">下+双</span></td>
        <td width="10%">数据</td>
        <td>平均欧赔</td>
            </tr>
      </table>
    ...
    <div class="zk_list" id="navbox_tz" style="height:0px;opacity:0;overflow:hidden;">
        ...
        <div class="dzm_c">
          ...
          <div class="cont xial_ks w-k" style="display:none; "> <a href="javascript:void 0" id="showStartTimeId">开赛</a> </div>
        </div>
    <!--赛事和停售 end-->
    <div class="sais_c" id="accordion">
              
    </div>
    <jsp:include page="./bjdcfooter.jsp"></jsp:include>
    <div class="botoom_sm">
          <h1>投注提示</h1>
