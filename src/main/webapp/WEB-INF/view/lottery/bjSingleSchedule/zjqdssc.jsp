...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<c:set var="pageName" value="北京单场总进球单式上传" scope="page"></c:set>
...
<div id="betPanalId">
      ...
      <jsp:include page="./header.jsp"></jsp:include>
    	...
    	<div class="sais_c">
         <div class="w_ggfs">
         	<div class="w_ggfs_t">
         	<input type="radio" name="typesel" onclick="location.href='/lottery/index.jhtml?licenseId=21&p=zjq'" <c:if test="${p == 'zjq' }">checked</c:if>/>
			过关投注
         	<input type="radio" name="typesel" onclick="location.href='/lottery/index.jhtml?licenseId=21&p=zjqdssc'" <c:if test="${p == 'zjqdssc' }">checked</c:if>/>
			单式上传
