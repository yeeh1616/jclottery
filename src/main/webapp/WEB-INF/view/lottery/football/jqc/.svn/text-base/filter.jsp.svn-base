...
<div class=" w_jjyh" id="betPanalId">
  <div class="prompt">
    <div class="promptl fl"><a href="javascript:void 0" class="zxgl_logo fl"></a><span>足彩 四场进球</span>
      <div class="clear"></div>
    </div>
      ...
      <div class="zx_content_cc"> 
       <a href="javascript:void 0" name="confArea" class="zx_listbtn">常规过滤</a>
        <ul class="zx_listbtnf">
          <li><a href="javascript:void 0" conf="120" type="1"><i class="gldx"></i>0球场次</a></li>
          <li><a href="javascript:void 0" conf="121" type="1"><i class="gldx"></i>1球场次</a></li>
          <li><a href="javascript:void 0" conf="122" type="1"><i class="gldx"></i>2球场次</a></li>
          <li><a href="javascript:void 0" conf="123" type="1"><i class="gldx"></i>3+球场次</a></li>
...
<script type="text/javascript" src="http://${domain.collectionHost}/global/schudle/8/${game.issue }.js"></script>
<script type="text/javascript" src="/js/lottery/football/Filter.js"></script>
<script type="text/javascript" src="/js/lottery/football/jqc/filter.js"></script>
