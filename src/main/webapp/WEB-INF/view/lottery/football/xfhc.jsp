...
<body>
	...
	<script type="text/javascript"
		src="/js/lottery/common/CombAlgorithm.js"></script>
	...
	<script type="text/javascript"
		src="/data/lottery/football/sfc/${game.issue }.js"></script>
	<script type="text/javascript" src="/data/lottery/football/bqcbonus.js"></script>
	<script type="text/javascript"
		src="/js/lottery/football/rxj/pageControl.js"></script>
	<script type="text/javascript"
		src="/js/lottery/football/pubPageControl.js"></script>
...
<!-- 这里的顶部和其他的老足彩 的顶部不一样请注意-->      
    <div class="jz_top">
          <div class="jz_tz fl">
        <div class="oldball-logo"></div>
      </div>
          <div class="jztz_name fl">
        <h1>老足彩</h1>
        <span>单注最高奖金5,000,000元</span></div>
...
<jsp:include page="menu.jsp" />
    ...
    <div class="sais_c">
         <div class="w_ggfs">
         	<div class="w_ggfs_t">
         	请先选择玩法:<input type="radio" name="singleRadio" value="5" checked="checked"/>胜负彩<input type="radio" value="6" name="singleRadio"/>任选九
					<input type="radio" value="8" name="singleRadio"/>4场进球<input type="radio" value="7" name="singleRadio"/>6场半全场
					</div> 
<div class="w_hm">
<div class="w_gmxs">
            <ul>
              <li>购买方式：</li>
              <li><input type="radio" name="buyType" checked="checked" value="3"/>合买</li>
              <div class="clear"></div>
            </ul>
          </div>
  ...
  <tr>
    ...
    <div class="w_fencheng fl"><input type="text" value="1" id="yjTotalBuyNumId" style="width: 30px;"/>&nbsp;&nbsp;注，
    <input type="text" value="1" id="yjTotalBuyMulId" style="width: 30px;"/>&nbsp;&nbsp;倍。 <span>上传方案金额浮动不超过20%。如方案10000元，可以上传8000-12000元的方案.</span></div>
...
<div class="tz_tk"><input name="" type="checkbox" value="agreeId" checked="checked" />我已阅读并同意<a href="/common/agreement.jhtml" target="_blank"><span>《彩店与彩民交易协议》</span></a></div>
</div>
         </div> 
        </div>
		<!--悬浮栏开始-->
