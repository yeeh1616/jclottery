...
<div class=" w_jjyh" id="betPanalId">
  <div class="prompt">
    <div class="promptl fl"><a href="javascript:void 0" class="zxgl_logo fl"></a><span>足彩 任选九场</span>
      <div class="clear"></div>
    </div>
...
<script type="text/javascript" src="/js/lottery/football/rxj/filter.js"></script>
