...
<div class=" w_jjyh" id="betPanalId">
  <div class="prompt">
    <div class="promptl fl"><a href="javascript:void 0" class="zxgl_logo fl"></a><span>足彩 6场半全</span>
      <div class="clear"></div>
    </div>
...
<script type="text/javascript" src="http://${domain.collectionHost}/global/schudle/7/${game.issue }.js"></script>
<script type="text/javascript" src="/js/lottery/football/Filter.js"></script>
<script type="text/javascript" src="/js/lottery/football/bqc/filter.js"></script>
