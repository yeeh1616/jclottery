...
<c:set var="pageName" value="20选5" scope="page"></c:set>
...
<script type="text/javascript" src="/js/lottery/20x5/C20x5.js"></script>
<script type="text/javascript" src="/js/lottery/omit/omit.js"></script>
<script type="text/javascript" src="/js/lottery/20x5/20x5dt.js"></script>
...
<div class="hq_n" style="width: 530px; margin-left:100px;" id="beforeDanAreaId">
</div>

<div class="hq_n" style="width: 530px; margin-left:100px;" id="beforeTuoAreaId">
</div>
