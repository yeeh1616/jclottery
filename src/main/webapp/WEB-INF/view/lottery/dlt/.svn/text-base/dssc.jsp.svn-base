...
<div class="common_w" id="betPanalId">  
    ...
    <div class="sais_c">
         <div class="w_ggfs">
				...
				<div class="ckgs"><a name="daletou" href="javascript:void(0)">查看上传格式</a></div>
				</div>
				           <div class="w_ggfs_c"><span class="w_peim">2</span>确认提交</div> 
				            <div class="w_ggfsc_fxc">
				            <div class="jzsj"><input type="checkbox" id="zjBoxId"/>追加投注 该方案截止时间：<span>${fn:substring(game.stopTime,0,16)}</span></div>
				            	<p>
				            	我要购买倍<span class="tjjs"><a href="javascript:void 0" id="subMBtnId">-</a>
				                ...
				                <div class="qrfk w_anniu"><a href="javascript:void 0" class="quer" id="lotteryFormBtnId">确认提交</a></div>
				            </div> 
         </div> 
        </div>
