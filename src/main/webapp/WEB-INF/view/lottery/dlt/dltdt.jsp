...
<script type="text/javascript" src="/js/lottery/dlt/dltdt.js"></script>
...
<div class="hq_n" id="beforeDanAreaId">
</div>
<div class="lq" id="afterDanAreaId">
</div>
<div class="hq_n" id="beforeTuoAreaId">
</div>
<div class="lq" id="afterTuoAreaId">
</div>
<div class="clear"></div>
