    ...
    <div class="sais_c">
         ...
         <div class="w_ggfs">
         	<div class="w_ggfs_t">请先选择玩法:
         		<input type="radio" name="playTypeName" value="1" checked/>胜负
         		<input type="radio" name="playTypeName" value="2"/>让分胜负
         		<input type="radio" name="playTypeName" value="3"/>胜分差
         		<input type="radio" name="playTypeName" value="4"/>大小分
         	</div> 
<div class="w_hm">
<div class="w_gmxs">
          </div>
