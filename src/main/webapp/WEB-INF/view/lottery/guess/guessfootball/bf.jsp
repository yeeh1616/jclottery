...
<div class="big_bg" id="betPanalId">
    ...
    <div id="navlist_tz" class="sais_t">
    		<div class="w_shengfuchoose"><span>
		            <input type="radio" name="typesel" onclick="location.href='/lottery/index.jhtml?licenseId=9&p=bf'" <c:if test="${p == 'bf' }">checked</c:if>/>
		            过关投注</span><span>
		            <input type="radio" name="typesel" onclick="location.href='/lottery/index.jhtml?licenseId=9&p=bfdg'" <c:if test="${p == 'bfdg' }">checked</c:if>/>
		            单关投注</span> </div>
