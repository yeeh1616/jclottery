...
<body>
	...
	<script type="text/javascript" src="/js/lottery/guess/xfhc.js"></script>
    ...
    <div class="sais_c">
         ...
         <div class="w_ggfs">
         	<div class="w_ggfs_t">请选择玩法(单一玩法支持文件上传):
         		<input type="radio" name="playTypeName" value="6" checked/>混合过关(<font color=red>复式预投</font>)
         		<input type="radio" name="playTypeName" value="1"/>胜平负
         		<input type="radio" name="playTypeName" value="2"/>让球平胜负
         		<input type="radio" name="playTypeName" value="4"/>半全场
         		<input type="radio" name="playTypeName" value="5"/>比分
         		<input type="radio" name="playTypeName" value="3"/>总进球</div> 
<div class="w_hm">
<div class="w_gmxs">
          </div>
  ...
  <tr>
    ...
    <input type="text" class="w_rgtx" value="1" id="yjTotalBuyMulId" style="width: 30px;"/>&nbsp;&nbsp;倍。 <span>上传方案金额浮动不超过20%。如方案10000元，可以上传8000-12000元的方案.</span></div>
