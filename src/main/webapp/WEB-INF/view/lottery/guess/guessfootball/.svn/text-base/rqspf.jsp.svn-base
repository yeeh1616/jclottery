...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<c:set var="pageName" value="竞彩足球让球胜平负" scope="page"></c:set>
...
<div class="big_bg" id="betPanalId">
    ...
    <div id="navlist_tz" class="sais_t">
           <div class="w_shengfuchoose"><span>
		            <input type="radio" name="typesel" onclick="location.href='/lottery/index.jhtml?licenseId=9&p=hhspf'" <c:if test="${p == 'hhspf' }">checked</c:if>/>
		            胜平负/让球</span><span>
		            <input type="radio" name="typesel" onclick="location.href='/lottery/index.jhtml?licenseId=9&p=spf'" <c:if test="${p == 'spf' }">checked</c:if>/>
		            胜平负</span> <span>
		            <input type="radio" name="typesel" onclick="location.href='/lottery/index.jhtml?licenseId=9&p=rqspf'" <c:if test="${p == 'rqspf' }">checked</c:if>/>
		            让球胜平负</span></div>
...
<tr>
        ...
        <td width="36%"><span class="qr_wsj_tlns">让球</span><span class="qr_wsj_tcn">胜</span><span class="qr_wsj_tcn">平</span><span class="qr_wsj_tcn">负</span></td>
        <td width="10%">数据</td>
        <td>平均欧赔</td>
            </tr>
      </table>
