...
<div class="big_bg" id="betPanalId">
    ...
    <div id="navlist_tz" class="sais_t">
    	<div class="w_shengfuchoose"><span>
		            <input type="radio" name="typesel" onclick="location.href='/lottery/index.jhtml?licenseId=9&p=bqc'" <c:if test="${p == 'bqc' }">checked</c:if>/>
		            过关投注</span><span>
		            <input type="radio" name="typesel" onclick="location.href='/lottery/index.jhtml?licenseId=9&p=bqcdg'" <c:if test="${p == 'bqcdg' }">checked</c:if>/>
		            单关投注</span> </div>
