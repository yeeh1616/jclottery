...
<script type="text/javascript" src="/js/lottery/pl3/${p }.js"></script>
...
<jsp:include page="./zxheader.jsp"></jsp:include>
<div class="dan-ts"><span>胆码区</span>&nbsp;设为必出的号码&nbsp;最多选择<span>2</span>个号码球</div>
<div class="hq t_qxch" id="danAreaDivId">
</div>
<div class="clear"></div>
<div class="dan-ts"><span>拖码区</span>&nbsp;至少选择<span>1</span>个号码球</div>
<div class="hq t_qxch" id="tuoAreaDivId">
</div>
<div class="clear"></div>
<div class="cloose_touzhu">
     <div class="wcloose_top">
        ...
        <div class="wcloose_top_l fl">您选择了<b id="betNumId">0</b> 注，共 ￥ <b id="betMoneyId">0</b> 元</div>
