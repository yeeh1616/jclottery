...
<c:set var="pageName" value="双色球" scope="page"></c:set>
...
<script type="text/javascript" src="/js/lottery/ssq/Ssq.js"></script>
<script type="text/javascript" src="/js/lottery/omit/omit.js"></script>
<script type="text/javascript" src="/js/lottery/ssq/ssqdt.js"></script>
...
<div class="hq_n" style="width: 480px;" id="beforeTuoAreaId">
</div>
<div class="lq" style="width: 215px;" id="afterTuoAreaId">
</div>
<div class="clear"></div>
