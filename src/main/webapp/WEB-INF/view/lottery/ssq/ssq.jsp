...
<script type="text/javascript" src="/js/lottery/ssq/ssqpt.js"></script>
...
<div class="hq_n" style="width: 480px;" id="beforeAreaId">

</div>
<div class="lq" style="width: 215px;" id="afterAreaId">
