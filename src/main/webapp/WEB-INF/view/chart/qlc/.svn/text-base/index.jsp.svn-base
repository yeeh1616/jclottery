...
<c:set var="pageName" value="走势图-体彩七乐彩走势图" scope="page"></c:set>
...
<div class="zou_pic">
 <div class="zou_pic_nav">
        <h3 class="fl">七乐彩</h3>
        <ul class="fl">
						<li class="hover"><a href="/chart/qlc_index.jhtml">开奖分布图</a></li>     
						<li><a href="/chart/qlc_jou.jhtml">奇偶分析图</a></li>        
						<li><a href="/chart/qlc_ys.jhtml">余数走势图</a></li>   
        </ul>        
        <div class="clear"></div>
